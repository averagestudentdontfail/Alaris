...
public class YoYHelperVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<YoYHelper>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(YoYHelperVector obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private bool empty() {
    bool ret = NQuantLibcPINVOKE.YoYHelperVector_empty(swigCPtr);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
