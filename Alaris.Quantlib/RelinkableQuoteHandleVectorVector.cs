...
public class RelinkableQuoteHandleVectorVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<RelinkableQuoteHandleVector>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(RelinkableQuoteHandleVectorVector obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private bool empty() {
    bool ret = NQuantLibcPINVOKE.RelinkableQuoteHandleVectorVector_empty(swigCPtr);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
