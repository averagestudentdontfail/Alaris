...
public class QuoteHandleVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<QuoteHandle>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(QuoteHandleVector obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private bool empty() {
    bool ret = NQuantLibcPINVOKE.QuoteHandleVector_empty(swigCPtr);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
