...
public class SymmetricSchurDecomposition : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(SymmetricSchurDecomposition obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public SymmetricSchurDecomposition(Matrix s) : this(NQuantLibcPINVOKE.new_SymmetricSchurDecomposition(Matrix.getCPtr(s)), true) {
