...
public class DefaultProbabilityHelperVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<DefaultProbabilityHelper>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(DefaultProbabilityHelperVector obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private bool empty() {
    bool ret = NQuantLibcPINVOKE.DefaultProbabilityHelperVector_empty(swigCPtr);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
