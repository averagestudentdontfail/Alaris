...
public class CashFlows : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(CashFlows obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public static double previousCashFlowAmount(Leg leg, bool includeSettlementDateFlows, Date settlementDate) {
    double ret = NQuantLibcPINVOKE.CashFlows_previousCashFlowAmount__SWIG_0(Leg.getCPtr(leg), includeSettlementDateFlows, Date.getCPtr(settlementDate));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static double previousCashFlowAmount(Leg leg, bool includeSettlementDateFlows) {
    double ret = NQuantLibcPINVOKE.CashFlows_previousCashFlowAmount__SWIG_1(Leg.getCPtr(leg), includeSettlementDateFlows);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static double nextCashFlowAmount(Leg leg, bool includeSettlementDateFlows, Date settlementDate) {
    double ret = NQuantLibcPINVOKE.CashFlows_nextCashFlowAmount__SWIG_0(Leg.getCPtr(leg), includeSettlementDateFlows, Date.getCPtr(settlementDate));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static double nextCashFlowAmount(Leg leg, bool includeSettlementDateFlows) {
    double ret = NQuantLibcPINVOKE.CashFlows_nextCashFlowAmount__SWIG_1(Leg.getCPtr(leg), includeSettlementDateFlows);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static double accrualPeriod(Leg leg, bool includeSettlementDateFlows, Date settlementDate) {
    double ret = NQuantLibcPINVOKE.CashFlows_accrualPeriod__SWIG_0(Leg.getCPtr(leg), includeSettlementDateFlows, Date.getCPtr(settlementDate));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static double accrualPeriod(Leg leg, bool includeSettlementDateFlows) {
    double ret = NQuantLibcPINVOKE.CashFlows_accrualPeriod__SWIG_1(Leg.getCPtr(leg), includeSettlementDateFlows);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static int accrualDays(Leg leg, bool includeSettlementDateFlows, Date settlementDate) {
    int ret = NQuantLibcPINVOKE.CashFlows_accrualDays__SWIG_0(Leg.getCPtr(leg), includeSettlementDateFlows, Date.getCPtr(settlementDate));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static int accrualDays(Leg leg, bool includeSettlementDateFlows) {
    int ret = NQuantLibcPINVOKE.CashFlows_accrualDays__SWIG_1(Leg.getCPtr(leg), includeSettlementDateFlows);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static double accruedPeriod(Leg leg, bool includeSettlementDateFlows, Date settlementDate) {
    double ret = NQuantLibcPINVOKE.CashFlows_accruedPeriod__SWIG_0(Leg.getCPtr(leg), includeSettlementDateFlows, Date.getCPtr(settlementDate));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static double accruedPeriod(Leg leg, bool includeSettlementDateFlows) {
    double ret = NQuantLibcPINVOKE.CashFlows_accruedPeriod__SWIG_1(Leg.getCPtr(leg), includeSettlementDateFlows);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static int accruedDays(Leg leg, bool includeSettlementDateFlows, Date settlementDate) {
    int ret = NQuantLibcPINVOKE.CashFlows_accruedDays__SWIG_0(Leg.getCPtr(leg), includeSettlementDateFlows, Date.getCPtr(settlementDate));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static int accruedDays(Leg leg, bool includeSettlementDateFlows) {
    int ret = NQuantLibcPINVOKE.CashFlows_accruedDays__SWIG_1(Leg.getCPtr(leg), includeSettlementDateFlows);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static double accruedAmount(Leg leg, bool includeSettlementDateFlows, Date settlementDate) {
    double ret = NQuantLibcPINVOKE.CashFlows_accruedAmount__SWIG_0(Leg.getCPtr(leg), includeSettlementDateFlows, Date.getCPtr(settlementDate));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static double accruedAmount(Leg leg, bool includeSettlementDateFlows) {
    double ret = NQuantLibcPINVOKE.CashFlows_accruedAmount__SWIG_1(Leg.getCPtr(leg), includeSettlementDateFlows);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static CashFlow previousCashFlow(Leg leg, bool includeSettlementDateFlows, Date settlementDate) {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.CashFlows_previousCashFlow__SWIG_0(Leg.getCPtr(leg), includeSettlementDateFlows, Date.getCPtr(settlementDate));
    CashFlow ret = (cPtr == global::System.IntPtr.Zero) ? null : new CashFlow(cPtr, true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static CashFlow previousCashFlow(Leg leg, bool includeSettlementDateFlows) {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.CashFlows_previousCashFlow__SWIG_1(Leg.getCPtr(leg), includeSettlementDateFlows);
    CashFlow ret = (cPtr == global::System.IntPtr.Zero) ? null : new CashFlow(cPtr, true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static CashFlow nextCashFlow(Leg leg, bool includeSettlementDateFlows, Date settlementDate) {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.CashFlows_nextCashFlow__SWIG_0(Leg.getCPtr(leg), includeSettlementDateFlows, Date.getCPtr(settlementDate));
    CashFlow ret = (cPtr == global::System.IntPtr.Zero) ? null : new CashFlow(cPtr, true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static CashFlow nextCashFlow(Leg leg, bool includeSettlementDateFlows) {
    global::System.IntPtr cPtr = NQuantLibcPINVOKE.CashFlows_nextCashFlow__SWIG_1(Leg.getCPtr(leg), includeSettlementDateFlows);
    CashFlow ret = (cPtr == global::System.IntPtr.Zero) ? null : new CashFlow(cPtr, true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static DoublePair npvbps(Leg leg, YieldTermStructure discountCurve, bool includeSettlementDateFlows, Date settlementDate, Date npvDate) {
    DoublePair ret = new DoublePair(NQuantLibcPINVOKE.CashFlows_npvbps__SWIG_0(Leg.getCPtr(leg), YieldTermStructure.getCPtr(discountCurve), includeSettlementDateFlows, Date.getCPtr(settlementDate), Date.getCPtr(npvDate)), true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static DoublePair npvbps(Leg leg, YieldTermStructure discountCurve, bool includeSettlementDateFlows, Date settlementDate) {
    DoublePair ret = new DoublePair(NQuantLibcPINVOKE.CashFlows_npvbps__SWIG_1(Leg.getCPtr(leg), YieldTermStructure.getCPtr(discountCurve), includeSettlementDateFlows, Date.getCPtr(settlementDate)), true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static DoublePair npvbps(Leg leg, YieldTermStructure discountCurve, bool includeSettlementDateFlows) {
    DoublePair ret = new DoublePair(NQuantLibcPINVOKE.CashFlows_npvbps__SWIG_2(Leg.getCPtr(leg), YieldTermStructure.getCPtr(discountCurve), includeSettlementDateFlows), true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static DoublePair npvbps(Leg leg, YieldTermStructureHandle discountCurve, bool includeSettlementDateFlows, Date settlementDate, Date npvDate) {
    DoublePair ret = new DoublePair(NQuantLibcPINVOKE.CashFlows_npvbps__SWIG_3(Leg.getCPtr(leg), YieldTermStructureHandle.getCPtr(discountCurve), includeSettlementDateFlows, Date.getCPtr(settlementDate), Date.getCPtr(npvDate)), true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static DoublePair npvbps(Leg leg, YieldTermStructureHandle discountCurve, bool includeSettlementDateFlows, Date settlementDate) {
    DoublePair ret = new DoublePair(NQuantLibcPINVOKE.CashFlows_npvbps__SWIG_4(Leg.getCPtr(leg), YieldTermStructureHandle.getCPtr(discountCurve), includeSettlementDateFlows, Date.getCPtr(settlementDate)), true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static DoublePair npvbps(Leg leg, YieldTermStructureHandle discountCurve, bool includeSettlementDateFlows) {
    DoublePair ret = new DoublePair(NQuantLibcPINVOKE.CashFlows_npvbps__SWIG_5(Leg.getCPtr(leg), YieldTermStructureHandle.getCPtr(discountCurve), includeSettlementDateFlows), true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
