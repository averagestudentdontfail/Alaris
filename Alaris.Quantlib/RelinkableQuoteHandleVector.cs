...
public class RelinkableQuoteHandleVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<RelinkableQuoteHandle>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(RelinkableQuoteHandleVector obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private bool empty() {
    bool ret = NQuantLibcPINVOKE.RelinkableQuoteHandleVector_empty(swigCPtr);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
