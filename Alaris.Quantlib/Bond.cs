...
public class Bond : Instrument {
  ...
  public double yield(BondPrice price, DayCounter dc, Compounding compounding, Frequency freq, Date settlement, double accuracy, uint maxEvaluations, double guess) {
    double ret = NQuantLibcPINVOKE.Bond_yield__SWIG_3(swigCPtr, BondPrice.getCPtr(price), DayCounter.getCPtr(dc), (int)compounding, (int)freq, Date.getCPtr(settlement), accuracy, maxEvaluations, guess);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public double yield(BondPrice price, DayCounter dc, Compounding compounding, Frequency freq, Date settlement, double accuracy, uint maxEvaluations) {
    double ret = NQuantLibcPINVOKE.Bond_yield__SWIG_4(swigCPtr, BondPrice.getCPtr(price), DayCounter.getCPtr(dc), (int)compounding, (int)freq, Date.getCPtr(settlement), accuracy, maxEvaluations);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public double yield(BondPrice price, DayCounter dc, Compounding compounding, Frequency freq, Date settlement, double accuracy) {
    double ret = NQuantLibcPINVOKE.Bond_yield__SWIG_5(swigCPtr, BondPrice.getCPtr(price), DayCounter.getCPtr(dc), (int)compounding, (int)freq, Date.getCPtr(settlement), accuracy);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public double yield(BondPrice price, DayCounter dc, Compounding compounding, Frequency freq, Date settlement) {
    double ret = NQuantLibcPINVOKE.Bond_yield__SWIG_6(swigCPtr, BondPrice.getCPtr(price), DayCounter.getCPtr(dc), (int)compounding, (int)freq, Date.getCPtr(settlement));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public double yield(BondPrice price, DayCounter dc, Compounding compounding, Frequency freq) {
    double ret = NQuantLibcPINVOKE.Bond_yield__SWIG_7(swigCPtr, BondPrice.getCPtr(price), DayCounter.getCPtr(dc), (int)compounding, (int)freq);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
