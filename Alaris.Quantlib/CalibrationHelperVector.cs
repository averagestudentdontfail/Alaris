...
public class CalibrationHelperVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<CalibrationHelper>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(CalibrationHelperVector obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public CalibrationHelperVector(global::System.Collections.Generic.IEnumerable<CalibrationHelper> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (CalibrationHelper element in c) {
      this.Add(element);
  ...
  public CalibrationHelper[] ToArray() {
    CalibrationHelper[] array = new CalibrationHelper[this.Count];
    this.CopyTo(array);
    return array;
  }
  ...
  private bool empty() {
    bool ret = NQuantLibcPINVOKE.CalibrationHelperVector_empty(swigCPtr);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  private CalibrationHelper getitemcopy(int index) {
    ...
    CalibrationHelper ret = (cPtr == global::System.IntPtr.Zero) ? null : new CalibrationHelper(cPtr, true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
