...
public class Date : global::System.IDisposable, global::System.IComparable {
  ...
  public static Date startOfMonth(Date arg0) {
    Date ret = new Date(NQuantLibcPINVOKE.Date_startOfMonth(Date.getCPtr(arg0)), true);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static bool isStartOfMonth(Date arg0) {
    bool ret = NQuantLibcPINVOKE.Date_isStartOfMonth(Date.getCPtr(arg0));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public int Subtract(Date other) {
    int ret = NQuantLibcPINVOKE.Date_Subtract__SWIG_2(swigCPtr, Date.getCPtr(other));
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
