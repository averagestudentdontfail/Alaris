...
public sealed class DTmd003ATests
{
    ...
    public void GetPriceMultiplier_TwoForOneSplit_ReturnsHalf()
    {
        ...
        // Act
        decimal multiplier = action.GetPriceMultiplier();
    ...
    public void GetStrikeMultiplier_TwoForOneSplit_ReturnsHalf()
    {
        ...
        // Act
        decimal multiplier = action.GetStrikeMultiplier();
    ...
    public void Equals_SameValues_ReturnsTrue()
    {
        ...
        DTmd003A action1 = new DTmd003A("AAPL", date, CorporateActionType.Split, 2m, "Split");
        DTmd003A action2 = new DTmd003A("AAPL", date, CorporateActionType.Split, 2m, "Split");
    ...
    public void Equals_DifferentSymbol_ReturnsFalse()
    {
        ...
        DateTime date = new DateTime(2024, 1, 15);
        DTmd003A action1 = new DTmd003A("AAPL", date, CorporateActionType.Split, 2m, "Split");
        DTmd003A action2 = new DTmd003A("NVDA", date, CorporateActionType.Split, 2m, "Split");
