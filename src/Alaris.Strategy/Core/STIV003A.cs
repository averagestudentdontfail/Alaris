...
public sealed class STIV003A
{
    ...
    public ModelSelectionResult SelectBestModel(ModelSelectionContext context)
    {
        ...
        // Detect regime
        STTM002A regime = context.Regime ?? STTM002A.Detect(context.TimeParams);
    ...
    /// </summary>
    private static IReadOnlyList<RecommendedModel> GetCandidateModels(STTM002A regime)
    {
    ...
    private static string GenerateSelectionReason(ModelEvaluation best, STTM002A regime)
    {
...
public sealed class ModelSelectionContext
{
    ...
    /// Time parameters.
    /// </summary>
    public required STTM004A TimeParams { get; init; }

    /// <summary>
    /// Pre-detected regime (optional).
    /// </summary>
    public STTM002A? Regime { get; init; }
...
public sealed class ModelSelectionResult
{
    ...
    /// Detected regime.
    /// </summary>
    public required STTM002A Regime { get; init; }
