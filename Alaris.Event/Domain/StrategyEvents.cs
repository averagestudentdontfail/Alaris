...
/// </summary>
public sealed record SignalGeneratedEvent : IEvent
{
    public required Guid EventId { get; init; }
    public required DateTime OccurredAtUtc { get; init; }
    public string EventType => nameof(SignalGeneratedEvent);
    ...
    /// </summary>
    public required double TermStructureSlope { get; init; }
...
/// </summary>
public sealed record OpportunityEvaluatedEvent : IEvent
{
    public required Guid EventId { get; init; }
    public required DateTime OccurredAtUtc { get; init; }
...
/// </summary>
public sealed record OptionPricedEvent : IEvent
{
    public required Guid EventId { get; init; }
    public required DateTime OccurredAtUtc { get; init; }
...
/// </summary>
public sealed record CalendarSpreadPricedEvent : IEvent
{
    public required Guid EventId { get; init; }
    public required DateTime OccurredAtUtc { get; init; }
    public string EventType => nameof(CalendarSpreadPricedEvent);
    public string? CorrelationId { get; init; }
...
/// </summary>
public sealed record PositionSizeCalculatedEvent : IEvent
{
    public required Guid EventId { get; init; }
    public required DateTime OccurredAtUtc { get; init; }
