...
**1. CA301A.cs:274 - `PriceWithQuantlib` (110 → 48 lines) ⭐ CRITICAL**
...
- `CreateCA106As`: 31 lines (term structure creation)
...
**2. CA111A.cs:75 - `Generate` (90 → 54 lines)**
...
**6. CA502A.cs:75 - `Solve` (74 → 20 lines)**
...
|------|--------|--------|-------|-----------|
| CA301A.cs | PriceWithQuantlib | 110 lines | 48 lines | -62 lines |
| CA111A.cs | Generate | 90 lines | 54 lines | -36 lines |
| CA108A.cs | Calculate | 76 lines | 34 lines | -42 lines |
| CA301A.cs | PriceCA321A | 74 lines | 22 lines | -52 lines |
| CA301A.cs | CalculateBreakEven | 73 lines | 28 lines | -45 lines |
| CA502A.cs | Solve | 74 lines | 20 lines | -54 lines |
...
- CA111A.cs - `CA111A()`, `Generate()`
- CA301A.cs - `PriceOption()`, `PriceCA321A()`, `CalculateImpliedVolatility()`
- CA108A.cs - `Calculate()`, `CalculateRolling()`
- CA401A.cs - `CalculateFromHistory()`
- QuasiAnalyticApproximation.cs - `CA505A()`

**Violation Fixed**:

**CA502A.cs:49 - Constructor missing guard clauses**
...
1. **Bridge/CA301A.cs**
   ...
   - Refactored `PriceCA321A` (3 methods)
...
### Factory Pattern
- `CreateCA312As` in CA301A
- `CreateCA106As` for QuantLib objects

### Strategy Pattern
- `CA502A.Solve` with different solving strategies
- Single Boundary vs Double Boundary vs QD+ only

### Builder Pattern
- `BuildCA321APricing` for result construction
