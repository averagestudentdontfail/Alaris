...
// Component: DTea001B | Category: Earnings | Variant: B (Alternative)
// =============================================================================
// Reference: Alaris.Governance/Structure.md § 4.3.3
// Compliance: High-Integrity Coding Standard v1.2
// =============================================================================
// SEC API Documentation: https://www.sec.gov/developer
// Rate Limit: 10 requests/second (enforced via User-Agent header)
// =============================================================================
...
namespace Alaris.Data.Provider.SEC;
...
#region SEC API Response Models
