...
// Component: DTsr001A | Category: Serialization | Variant: A (Primary)
// =============================================================================
// Bridges Alaris.Data.Model types to Alaris.Protocol binary format.
// Provides zero-allocation serialization for cache and event storage.
// =============================================================================
// References:
...
namespace Alaris.Data.Serialization;
...
public static class DTsr001A
{
    ...
    #region OptionContract Serialization
    ...
    #region OptionChainSnapshot Serialization
