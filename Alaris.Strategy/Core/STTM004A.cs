...
public sealed class STTM004A
{
    ...
    private static int CalculateTradingDays(DateTime start, DateTime end)
    {
        ...
        int days = STTM003A.GetTradingDays(start, end, includeEndDate: false);
...
public sealed class TimeConstraints
{
    ...
    /// </summary>
    public double MinTimeToExpiry { get; init; } = STTM004A.MinTimeToExpiry;

    /// <summary>
    /// Maximum time to expiry in years.
    /// </summary>
    public double MaxTimeToExpiry { get; init; } = STTM004A.MaxTimeToExpiry;
    ...
    /// </summary>
    public ValidationResult ValidatePreEarnings(STTM004A timeParams)
    {
