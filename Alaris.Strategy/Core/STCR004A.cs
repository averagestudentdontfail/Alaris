...
public sealed class STCR004A
{
    ...
    /// </summary>
    public STCR004AStrength Strength { get; set; }
    ...
    /// </summary>
    public double STTM001ASlope { get; set; }
    ...
    /// </summary>
    public DateTime STCR004ADate { get; set; }
    ...
    /// </summary>
    public double IVMispricingSTCR004A { get; set; }
    ...
    public void EvaluateStrength()
    {
        ...
        {
            (true, true, true) => STCR004AStrength.Recommended,
            (true, false, true) or (false, true, true) => STCR004AStrength.Consider,
            _ => STCR004AStrength.Avoid
        };
    }
}

/// <summary>
/// STCR004A strength classification for trading decisions.
/// </summary>
