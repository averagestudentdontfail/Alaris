...
public sealed class STTM001A
{
    ...
    public STTM001AAnalysis Analyze(IReadOnlyList<STTM001APoint> points)
    {
        ...
        try
        {
            ...
            STTM001AAnalysis analysis = new STTM001AAnalysis
            {
                Intercept = intercept,
                Slope = slope,
                RSquared = rSquared
...
/// </summary>
public sealed class STTM001APoint
{
    /// <summary>
...
/// </summary>
public sealed class STTM001AAnalysis
{
    /// <summary>
    ...
    /// </summary>
    public IList<STTM001APoint> Points { get; } = new List<STTM001APoint>();
